...
NAME = rtv1
OBJSRC  = srcs/main.o srcs/math.o srcs/mathnorm.o srcs/camera.o srcs/key.o srcs/tools.o srcs/free.o srcs/init.o srcs/sphere.o srcs/cylinder.o srcs/cone.o srcs/draw.o srcs/plane.o srcs/rotation.o
...
$(NAME): $(OBJS) 
	@make -s -C libft
	@gcc $(FLG) libft/libft.a $(OBJS) minilibx_macos/libmlx.a -framework OpenGL -framework AppKit -o $(NAME) -I $(INCS)
